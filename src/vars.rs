...
pub fn run() {
    ...
    println!("Memory address of const is: {:}", &MAX_POINTS);
    let i2: i64 = 1;
    let i3: i64 = 2;
    println!("Stack address of i2 is: {:p}", &i2);
    println!("Stack address of i3 is: {:p}", &i3);
    println!("Stack address of i2 is: {:}", &i2);
    println!("Stack address of i3 is: {:}", &i3);
    ...
    // let (_x, _y, _z) = t1;
    println!("The value of x is: {} {} {}", t1.0, t1.1, t1.2);
    ...
    *y1_ptr = -5;
    ...
    let s1 = "helloこんにちは挨拶";
    let s2 = "hello";
    println!("Stack address os s is {:p}", &s1);
    println!("Stack address os s is {:p}", &s2);
    println!("Static memory address of s1: {:?}", s1.as_ptr());
    println!("Static memory address of s2: {}", s1.len());
    println!("Static memory address of s1: {}", s2.len());
